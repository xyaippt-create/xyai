...
def phase4_disabled():
    ...
    def inactive_policy(*args, **kwargs):
        ...
        return {
            ...
            "phase4_product_photo_eligible": False,
            "phase4_flat_region_protected": False,
            "phase4_product_subject_active": False,
            "phase4_gradient_background_protected": False,
            "phase4_flat_region_ratio": 0.0,
